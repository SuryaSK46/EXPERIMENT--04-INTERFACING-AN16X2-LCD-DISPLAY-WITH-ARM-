...
int main(void)
{
  ...
  Lcd_PortType ports[] = {GPIOA,GPIOA,GPIOA,GPIOA};
   ...
   Lcd_cursor(&lcd, 0,0);
   Lcd_string(&lcd, "SURYA SK\n");
   Lcd_cursor(&lcd, 1,2);
   Lcd_string(&lcd, "212222100052");
   HAL_Delay(500);
...
## Output screen shots of proteus  :
 ...
 ![1111](https://github.com/SuryaSK46/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/127716537/64331891-5fd4-43c3-9b3b-d5629a52ac83)

 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 
 ![image](https://github.com/SuryaSK46/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/127716537/f697b9ec-9429-4091-9c2d-6422d71d4958)
